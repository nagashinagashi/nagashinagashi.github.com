...
OpenSpending.Styles.Cofog = {
  ...
  '5-5': { icon: 'icons/wind.svg', color: '#C75746', bcolor: '#2A3A03'  },
  '6': { icon: 'icons/civilian-action.svg', color: '#C75746', bcolor: '#EC2406' },
  '6-6': { icon: 'icons/civilian-action.svg', color: '#C75746', bcolor: '#EC2406' },
  '7': { icon: 'icons/traffic-watersup.svg', color: '#C75746', bcolor: '#938626' },
  '7-7': { icon: 'icons/traffic-watersup.svg', color: '#C75746', bcolor: '#938626' },
  '8': { icon: 'icons/government.svg', color: '#C75746', bcolor: '#C75746' },
  '8-8': { icon: 'icons/publicaffairs.svg', color: '#C75746', bcolor: '#C75746' },
  '9': { icon: 'icons/garbage.svg', color: '#C75746', bcolor: '#D33673' },
  '9-9': { icon: 'icons/garbage.svg', color: '#C75746', bcolor: '#D33673' },
  '10': { icon: 'icons/order-safety.svg', color: '#C75746', bcolor: '#790586' },
  '10-10': { icon: 'icons/order-safety.svg', color: '#C75746', bcolor: '#790586' }
  '11': { icon: 'icons/garbage.svg', color: '#C75746', bcolor: '#D33673' },
  '11-11: { icon: 'icons/garbage.svg', color: '#C75746', bcolor: '#D33673' },
  '12': { icon: 'icons/garbage.svg', color: '#C75746', bcolor: '#D33673' },
  '12-12: { icon: 'icons/garbage.svg', color: '#C75746', bcolor: '#D33673' },
